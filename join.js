...
var storeSchema = new mongoose_1.Schema({
    ...
    songs: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'Song' }], // Lista de canciones disponibles en la tienda
});

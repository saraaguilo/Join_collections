...
// 3. Create a Model.
var Store = (0, mongoose_1.model)('Store', storeSchema);
run().catch(function (err) { return console.log(err); });
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var storeNameToCreate, existingStore, store, storeFromDB;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    // 4. Connect to MongoDB
                    _a.sent();
                    storeNameToCreate = 'Boutique';
                    return [4 /*yield*/, Store.findOne({ name: storeNameToCreate })];
                case 2:
                    existingStore = _a.sent();
                    if (!!existingStore) return [3 /*break*/, 4];
                    store = new Store({
                ...
                case 4:
                    ...
                    _a.label = 5;
                case 5: return [4 /*yield*/, Store.findOne({ name: 'Boutique' })];
                case 6:
                    storeFromDB = _a.sent();
                    if (storeFromDB) {
                    ...
                    if (!storeFromDB) return [3 /*break*/, 8];
                    storeFromDB.price_disk_song = 35;
                    return [4 /*yield*/, storeFromDB.save()];
                case 7:
                    _a.sent();
